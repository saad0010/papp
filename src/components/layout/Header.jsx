...
const Header = () => {
  ...
  return (
    <>
      <div className="w-full lg:h-8 h-8 bg-black">
        <div className="grid grid-cols-2">
          <div className=" col-span-1 hidden lg:grid text-center justify-items-center">
            <h3 className="text-white py-2 text-xs">
              Get a free custom-printed t-shirt quote from our Experts.
            </h3>
          </div>
          <div className="col-span-2 lg:col-span-1 ">
            <div className="grid grid-cols-2 lg:grid-cols-3 ">
              <div className="col-span-1 text-white  flex flex-row cursor-pointer  mx-auto hover:text-btnyel">
                <IoCallSharp className="ml-2 lg:ml-0 mt-2 mr-2" size={18} />
                <h3 className="mt-2   text-xs">323 - 686 - 3410</h3>
              </div>
              <div className="col-span-1 hidden lg:flex text-white  flex-row cursor-pointer hover:text-btnyel">
                <IoMailSharp className="mt-2 mr-2" size={18} />
                <h3 className="mt-2 text-xs ">info@printothread.com</h3>
              </div>
              <div className="col-span-1 text-white flex flex-row cursor-pointer  mx-auto lg:mx-0 hover:text-btnyel">
                <IoCallSharp className="mt-2 mr-2" size={18} />
                <h3 className="mt-2  text-xs">289 - 590 - 1970</h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className=" w-full lg:h-20 h-16  border-gray-500 px-2  bg-white overflow-x-hidden">
        <div className="h-full max-w-screen-2xl mx-auto flex items-center justify-between">
          ...
          <span
            onClick={() => setShowMenu(true)}
            className="absolute right-6 top-4.5 text-xl p-3 bg-black lg:hidden rounded-full text-white hover:text-yellow-400 cursor-pointer duration-300"
          >
            <IoMenuOutline />
          </span>
                    ...
                    <div className="text-center  ">
                      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:pb-4">
                        ...
                        <Link
                          ...
                          href={`/products`}
                        >
                          <div className="flex flex-col h-30 justify-between cursor-pointer   items-center">
                            <Image
                              src={"/all.webp"}
                              alt={"all products"}
                              width={50}
